...
pTree +
  ...
  scale_color_manual(values = c("20 years" = sfPal[1], "50 years" = sfPal[3], "100 years" = sfPal[5]), name = NULL) +
...
pTree +
  ...
  scale_color_manual(values = c("spar = 0.2" = sfPal[1], "spar = 0.4" = sfPal[3], "spar = 0.6" = sfPal[5]), name = NULL) +
...
plot(zooRad_approx[1:100], type = "b", pch = 20, ylab = expression(W ~ m^-2), col = sfPal[1], lwd = 2)
lines(zooRad_spline[1:100], lwd = 2, col = sfPal[5], lty = "dotted")
