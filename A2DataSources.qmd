...
The one piece of third-party artwork in the book, Allison Horst's autocorrelation illustration in the [Autocorrelation](04Autocorrelation.qmd) chapter, is reused under a Creative Commons license, with attribution as required. A machine-readable log of this credit, suitable for a publisher's permissions desk, lives in `permissions.csv` at the repository root.

| Image | Author | License | Source |
|---|---|---|---|
| Autocorrelation function illustration | Allison Horst | [CC BY 4.0](https://creativecommons.org/licenses/by/4.0/) | [allisonhorst.com](https://allisonhorst.com/time-series-acf) |
