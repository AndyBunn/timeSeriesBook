...
ggplot() +
  ...
  geom_line(data = forecast_tb, aes(year, yhat), color = sfPal[1]) +
  labs(x = "Year", y = "Sunspots (n)") +
...
ggplot() +
  ...
  geom_line(data = ar_tb, aes(year, yhat), color = sfPal[1]) +
  labs(x = "Year", y = "Recruits (thousands)",
       title = "AR forecast (teal) against the withheld decade (black)") +
  theme_minimal()
```
...
ggplot() +
  geom_line(data = test_tb, aes(year, rec)) +
  geom_line(data = hw_tb, aes(year, yhat), color = sfPal[5]) +
  labs(x = "Year", y = "Recruits (thousands)",
       title = "Holt-Winters forecast (red) against the withheld years") +
  theme_minimal()
```
