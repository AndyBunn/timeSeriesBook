...
We stay in the tsibble framework from the earlier chapters. `forecast` gives us the ggplot-ready ACF and PACF and the `Arima` fitting function, `gridExtra` lays a few plots out together, and `tseries` carries the ADF and KPSS tests we met last chapter.
