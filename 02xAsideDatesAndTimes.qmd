...
For environmental work that rounding error is harmless. But I'm mentioning it so you are not surprised when a timestamp is off by a handful of seconds from an atomic-clock reference.
