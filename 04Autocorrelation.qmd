...
We use the `tidyverse` [@R-tidyverse] for wrangling and plotting and `tsibble` [@Wang2020tsibble] to hold series as tidy tables, as in the earlier chapters. The `forecast` [@R-forecast] package gives us ggplot-ready ACF and PACF functions, and `gridExtra` [@R-gridExtra] helps lay a few plots out together.
...
knitr::include_graphics("assets/horst_acf.jpg", error = FALSE)
```
