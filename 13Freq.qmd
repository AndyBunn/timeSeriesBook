...
Every plot in this chapter has put something called spectral density on the y-axis, and up to now that's been a bit of a black box: a number `spectrum()` hands back that happens to spike in the right places. It's worth opening the box once I think.
...
- [Wavelets](14Wavelets.html) picks up where this chapter's Wrapping Up leaves off: what to do when a series's frequency content changes over time.
- [A Glimpse of Cross-Spectral Analysis](13xAsideCrossSpectrum.html) is a short detour for a question this chapter never asks about two series at once: does the lead one has over the other depend on which cycle you're looking at?
