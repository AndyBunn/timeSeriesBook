...
- **Forecasting**: Using a fitted model's correlation structure to predict future values, and being clear-eyed about what that uncertainty actually looks like.
