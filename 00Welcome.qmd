...
You can [download the data directly](https://github.com/AndyBunn/timeSeriesBook/releases/download/data-latest/data.zip) from the GitHub [repo](https://github.com/AndyBunn/timeSeriesBook). Here is a hard link to it:

```
https://github.com/AndyBunn/timeSeriesBook/releases/download/data-latest/data.zip
```
